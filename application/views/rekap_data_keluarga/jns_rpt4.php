 ...
 <?php
                     ...
                     $html_tab4="<center><bold>REKAPITULASI PESERTA KB PER MIX KONTRASEPSI HASIL PENDATAAN KELUARGA TINGKAT ".$pelaporan->getjudul($idkec,$iddesa,$iddusun,$idrt)."</bold><br><br></center>"; 
                     ...
                     $nocol = $pelaporan->build_nocol(14);
                         ...
                         $html_tab4 .= $tb_hslfilter->display('table table-bordered table-hover');
