 ...
 <?php
                       $pelaporan = new pelaporan;
                        ...
                        $html_tab9="<center><bold>REKAPITULASI HASIL PEMUTAKHIRAN DATA KELUARGA SEJAHTERA I TINGKAT ".$pelaporan->getjudul($idkec,$iddesa,$iddusun,$idrt)."</bold><br><br></center>"; 
                       ...
                       $jnocol = 20;
                        ...
                        $jdltbl =  array(
                                   ...
                                   $html_tab9 .= $tb_tab9->display('table table-bordered table-hover').'<br><br>';
