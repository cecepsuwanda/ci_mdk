 ...
 <?php
                       ...
                       $html_tab10=''; 
                        ...
                        $jdltbl =  array(
                                   ...
                                   $tb_tab10 = new mytable(array('id'=>'tbhslfilter','width'=>'100%','border'=>'2','cellpadding'=>'8','cellspacing'=>'0','style'=>'border-collapse: collapse'),
                                                              $jdltbl,
                                                              $dt_tb,$txt);

                                   $html_tab10 .= $tb_tab10->display('table table-bordered table-hover').'<br><br>';
