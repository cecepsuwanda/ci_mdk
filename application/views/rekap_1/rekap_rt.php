...
<div class="wrapper">
  ...
  <?php 
        $data['menu_active'] = array(106,112); 
...
<script>  
   ...
   function afterajax(data1)
   {
      ...
      oTable=$("#tbserverside").dataTable({
                    'bProcessing': true,
                    'bServerSide': true,
                    'sAjaxSource': "<?php echo base_url();?>index.php/dashboard/rekap_1_serverside",
                    'sServerMethod' : 'POST',
          ...
          'fnServerParams' : function(aoData){
                        ...
                        aoData.push({"name":"data","value":data1},
     ...
     $("#kec").change(function () {
      ...
      $("#dusun").change(function () {
       ...
       $("#filter_kec").click(function () {
          ...
          myajax('hslfilter',data,"<?php echo base_url();?>index.php/dashboard/rekap_1_filter",null,afterajax);
       });
