...
<div class="wrapper">
  ...
  <?php 
        $data['menu_active'] = array(219,220,235); 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>        
        <small>15. JUMLAH KELUARGA DENGAN ANAK BALITA MENURUT MENURUT KELOMPOK UMUR, JUMLAH BALITA, KEGIATAN POSYANDU DAN STATUS THP KS</small>
      </h1>
      <ol class="breadcrumb">
