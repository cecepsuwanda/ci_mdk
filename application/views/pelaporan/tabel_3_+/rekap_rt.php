...
<div class="wrapper">
  ...
  <?php 
        $data['menu_active'] = array(219,220,270); 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>3+. JUMLAH JIWA PEMILIH MENURUT KELOMPOK UMUR JENIS KELAMIN DAN STATUS DALAM KELUARGA</small>
      </h1>
      <ol class="breadcrumb">
...
<script>  
   ...
   var subfolder = encodeURIComponent('<?php  echo basename(dirname($_SERVER['PHP_SELF'])); ?>');
