...
<div class="wrapper">
  ...
  <?php 
        $data['menu_active'] = array(219,238,239,245); 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>5. JUMLAH USIA ANAK SEKOLAH, YANG SEKOLAH DAN TIDAK SEKOLAH MENURUT JENIS KELAMIN</small>
      </h1> 
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Tabel Kependudukan</a></li>
        <li class="active">Tabel Umum</li>
        <li class="active">Berdasarkan Wilayah</li>
      </ol>
    </section>
