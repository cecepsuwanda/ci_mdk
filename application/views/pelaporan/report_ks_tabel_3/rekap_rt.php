...
<div class="wrapper">
  ...
  <?php 
        $data['menu_active'] = array(219,254,258); 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Berdasarkan Individu, Umur dan Pendidikan</small>
      </h1> 
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Tabel Kependudukan</a></li>
        <li class="active">Tabel Status Kerja Pertahapan KS</li>       
      </ol>
    </section>
...
<script>  
   ...
   function cek_cmbumur()
    {
       ...
       var iskosong = true;
            ...
            isfilter = $("input[id^='cmbumur']:checked").length > 0;
        if (!isfilter) {
          isfilter = false;
          alert('PILIH OPTION UMUR TERLEBIH DAHULU !!!');
        } else {

          switch ($("input[id^='cmbumur']:checked").val()) {
          case '1':
    ...
    function get_cmbumurdata(data)
    {
          switch ($("input[id^='cmbumur']:checked").val()) {
          case '1':       
            data = data + "&data1=" + $('#txtumur1').val().replace(/_/g,'');
            break;
          case '2':       
            data = data + "&data1=" + $('#txtumur2').val().replace(/_/g,'');
            break;
          case '3':     
            data = data + "&data1=" + $('#txtumur3').val().replace(/_/g,'');
            break;
          case '4':       
            data = data + "&data1=" + $('#txtumur4').val().replace(/_/g,'');
            data = data + "&data2=" + $('#txtumur5').val().replace(/_/g,'');       
            break;
          }     
          data = data + "&cmbumur=" + $("input[id^='cmbumur']:checked").val();

      return data;      
    }

    function get_cmbedudata(data)
    {
          var i=0;  
   ...
   function cek_filter() {
      ...
      var iscmbumur = $("input[id^='cmbumur']").length > 0;
  ...
  $(function () {
     ...
     $('input[type="checkbox"].minimal, input[type="radio"].minimal').iCheck({
      ...
      $('#cmbumur1').on('ifChecked', function(event){
          cmbclick(1);
       });

      $('#cmbumur2').on('ifChecked', function(event){
         cmbclick(2);
       });

      $('#cmbumur3').on('ifChecked', function(event){
         cmbclick(3);
       });

      $('#cmbumur4').on('ifChecked', function(event){
        cmbclick(4);
       });
