...
<div class="wrapper">
  ...
  <?php 
        $data['menu_active'] = array(106,170); 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Register Data Keluarga R1 KS - R I PUS - R II PUS</small>
      </h1> 
      <ol class="breadcrumb">
  ...
  $(function () {
     ...
     $("#kec").change(function () {
      ...
      $("#filter_dusun").click(function () {
          ...
          var iddesa = $('#desa option:selected').val();
          var iddusun = $('#dusun option:selected').val();  
          var jns_rpt = $('#jns_rpt option:selected').val(); 
          var iscek = true; 

          iscek = idkec!=0 && iddesa!=0;          
          if(!iscek)
          {
