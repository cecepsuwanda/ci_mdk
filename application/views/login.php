  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url();?>index.php/login/index" method="post">
      <div class="form-group has-feedback">
        <input type="text" name="un" value="<?php echo $un; ?>" class="form-control" placeholder="Username">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="password" name="psw" value="<?php echo $psw; ?>" class="form-control" placeholder="Password">
